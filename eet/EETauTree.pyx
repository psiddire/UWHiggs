...
cdef class EETauTree:
    ...
    cdef TBranch* e1MVAIsoWPHZZ_branch
    cdef float e1MVAIsoWPHZZ_value

    cdef TBranch* e1MVAIsoWPLoose_branch
    cdef float e1MVAIsoWPLoose_value
    ...
    cdef TBranch* e1MVANoisoWPLoose_branch
    cdef float e1MVANoisoWPLoose_value
    ...
    cdef TBranch* e1ZTTGenDR_branch
    cdef float e1ZTTGenDR_value

    cdef TBranch* e1ZTTGenEta_branch
    cdef float e1ZTTGenEta_value

    cdef TBranch* e1ZTTGenMatching_branch
    cdef float e1ZTTGenMatching_value

    cdef TBranch* e1ZTTGenPhi_branch
    cdef float e1ZTTGenPhi_value

    cdef TBranch* e1ZTTGenPt_branch
    cdef float e1ZTTGenPt_value
    ...
    cdef TBranch* e2MVAIsoWPHZZ_branch
    cdef float e2MVAIsoWPHZZ_value

    cdef TBranch* e2MVAIsoWPLoose_branch
    cdef float e2MVAIsoWPLoose_value
    ...
    cdef TBranch* e2MVANoisoWPLoose_branch
    cdef float e2MVANoisoWPLoose_value
    ...
    cdef TBranch* e2ZTTGenDR_branch
    cdef float e2ZTTGenDR_value

    cdef TBranch* e2ZTTGenEta_branch
    cdef float e2ZTTGenEta_value

    cdef TBranch* e2ZTTGenMatching_branch
    cdef float e2ZTTGenMatching_value

    cdef TBranch* e2ZTTGenPhi_branch
    cdef float e2ZTTGenPhi_value

    cdef TBranch* e2ZTTGenPt_branch
    cdef float e2ZTTGenPt_value
    ...
    cdef setup_branches(self, TTree* the_tree):
        ...
        if not self.Rivet_VEta_branch and "Rivet_VEta":
            warnings.warn( "EETauTree: Expected branch Rivet_VEta does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.Rivet_VPt_branch and "Rivet_VPt":
            warnings.warn( "EETauTree: Expected branch Rivet_VPt does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.Rivet_errorCode_branch and "Rivet_errorCode":
            warnings.warn( "EETauTree: Expected branch Rivet_errorCode does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.Rivet_higgsEta_branch and "Rivet_higgsEta":
            warnings.warn( "EETauTree: Expected branch Rivet_higgsEta does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.Rivet_higgsPt_branch and "Rivet_higgsPt":
            warnings.warn( "EETauTree: Expected branch Rivet_higgsPt does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.Rivet_nJets25_branch and "Rivet_nJets25":
            warnings.warn( "EETauTree: Expected branch Rivet_nJets25 does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.Rivet_nJets30_branch and "Rivet_nJets30":
            warnings.warn( "EETauTree: Expected branch Rivet_nJets30 does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.Rivet_p4decay_VEta_branch and "Rivet_p4decay_VEta":
            warnings.warn( "EETauTree: Expected branch Rivet_p4decay_VEta does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.Rivet_p4decay_VPt_branch and "Rivet_p4decay_VPt":
            warnings.warn( "EETauTree: Expected branch Rivet_p4decay_VPt does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.Rivet_prodMode_branch and "Rivet_prodMode":
            warnings.warn( "EETauTree: Expected branch Rivet_prodMode does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.Rivet_stage0_cat_branch and "Rivet_stage0_cat":
            warnings.warn( "EETauTree: Expected branch Rivet_stage0_cat does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.Rivet_stage1_cat_pTjet25GeV_branch and "Rivet_stage1_cat_pTjet25GeV":
            warnings.warn( "EETauTree: Expected branch Rivet_stage1_cat_pTjet25GeV does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.Rivet_stage1_cat_pTjet30GeV_branch and "Rivet_stage1_cat_pTjet30GeV":
            warnings.warn( "EETauTree: Expected branch Rivet_stage1_cat_pTjet30GeV does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.Rivet_stage1p1_cat_branch and "Rivet_stage1p1_cat":
            warnings.warn( "EETauTree: Expected branch Rivet_stage1p1_cat does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.SingleTau180MediumPass_branch and "SingleTau180MediumPass":
            warnings.warn( "EETauTree: Expected branch SingleTau180MediumPass does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.SingleTau200MediumPass_branch and "SingleTau200MediumPass":
            warnings.warn( "EETauTree: Expected branch SingleTau200MediumPass does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.SingleTau220MediumPass_branch and "SingleTau220MediumPass":
            warnings.warn( "EETauTree: Expected branch SingleTau220MediumPass does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.bjetDeepCSVVeto20Medium_branch and "bjetDeepCSVVeto20Medium":
            warnings.warn( "EETauTree: Expected branch bjetDeepCSVVeto20Medium does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.bjetDeepCSVVeto20MediumWoNoisyJets_branch and "bjetDeepCSVVeto20MediumWoNoisyJets":
            warnings.warn( "EETauTree: Expected branch bjetDeepCSVVeto20MediumWoNoisyJets does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.bjetDeepCSVVeto20MediumWoNoisyJets_2017_DR0p5_branch and "bjetDeepCSVVeto20MediumWoNoisyJets_2017_DR0p5":
            warnings.warn( "EETauTree: Expected branch bjetDeepCSVVeto20MediumWoNoisyJets_2017_DR0p5 does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        #print "making e1MVAIsoWPHZZ"
        self.e1MVAIsoWPHZZ_branch = the_tree.GetBranch("e1MVAIsoWPHZZ")
        #if not self.e1MVAIsoWPHZZ_branch and "e1MVAIsoWPHZZ" not in self.complained:
        if not self.e1MVAIsoWPHZZ_branch and "e1MVAIsoWPHZZ":
            warnings.warn( "EETauTree: Expected branch e1MVAIsoWPHZZ does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e1MVAIsoWPHZZ")
        else:
            self.e1MVAIsoWPHZZ_branch.SetAddress(<void*>&self.e1MVAIsoWPHZZ_value)

        #print "making e1MVAIsoWPLoose"
        self.e1MVAIsoWPLoose_branch = the_tree.GetBranch("e1MVAIsoWPLoose")
        #if not self.e1MVAIsoWPLoose_branch and "e1MVAIsoWPLoose" not in self.complained:
        if not self.e1MVAIsoWPLoose_branch and "e1MVAIsoWPLoose":
            warnings.warn( "EETauTree: Expected branch e1MVAIsoWPLoose does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e1MVAIsoWPLoose")
        else:
            self.e1MVAIsoWPLoose_branch.SetAddress(<void*>&self.e1MVAIsoWPLoose_value)
        ...
        #print "making e1MVANoisoWPLoose"
        self.e1MVANoisoWPLoose_branch = the_tree.GetBranch("e1MVANoisoWPLoose")
        #if not self.e1MVANoisoWPLoose_branch and "e1MVANoisoWPLoose" not in self.complained:
        if not self.e1MVANoisoWPLoose_branch and "e1MVANoisoWPLoose":
            warnings.warn( "EETauTree: Expected branch e1MVANoisoWPLoose does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e1MVANoisoWPLoose")
        else:
            self.e1MVANoisoWPLoose_branch.SetAddress(<void*>&self.e1MVANoisoWPLoose_value)
        ...
        #print "making e1ZTTGenDR"
        self.e1ZTTGenDR_branch = the_tree.GetBranch("e1ZTTGenDR")
        #if not self.e1ZTTGenDR_branch and "e1ZTTGenDR" not in self.complained:
        if not self.e1ZTTGenDR_branch and "e1ZTTGenDR":
            warnings.warn( "EETauTree: Expected branch e1ZTTGenDR does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e1ZTTGenDR")
        else:
            self.e1ZTTGenDR_branch.SetAddress(<void*>&self.e1ZTTGenDR_value)

        #print "making e1ZTTGenEta"
        self.e1ZTTGenEta_branch = the_tree.GetBranch("e1ZTTGenEta")
        #if not self.e1ZTTGenEta_branch and "e1ZTTGenEta" not in self.complained:
        if not self.e1ZTTGenEta_branch and "e1ZTTGenEta":
            warnings.warn( "EETauTree: Expected branch e1ZTTGenEta does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e1ZTTGenEta")
        else:
            self.e1ZTTGenEta_branch.SetAddress(<void*>&self.e1ZTTGenEta_value)
        ...
        #print "making e1ZTTGenPhi"
        self.e1ZTTGenPhi_branch = the_tree.GetBranch("e1ZTTGenPhi")
        #if not self.e1ZTTGenPhi_branch and "e1ZTTGenPhi" not in self.complained:
        if not self.e1ZTTGenPhi_branch and "e1ZTTGenPhi":
            warnings.warn( "EETauTree: Expected branch e1ZTTGenPhi does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e1ZTTGenPhi")
        else:
            self.e1ZTTGenPhi_branch.SetAddress(<void*>&self.e1ZTTGenPhi_value)

        #print "making e1ZTTGenPt"
        self.e1ZTTGenPt_branch = the_tree.GetBranch("e1ZTTGenPt")
        #if not self.e1ZTTGenPt_branch and "e1ZTTGenPt" not in self.complained:
        if not self.e1ZTTGenPt_branch and "e1ZTTGenPt":
            warnings.warn( "EETauTree: Expected branch e1ZTTGenPt does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e1ZTTGenPt")
        else:
            self.e1ZTTGenPt_branch.SetAddress(<void*>&self.e1ZTTGenPt_value)
        ...
        #print "making e2MVAIsoWPHZZ"
        self.e2MVAIsoWPHZZ_branch = the_tree.GetBranch("e2MVAIsoWPHZZ")
        #if not self.e2MVAIsoWPHZZ_branch and "e2MVAIsoWPHZZ" not in self.complained:
        if not self.e2MVAIsoWPHZZ_branch and "e2MVAIsoWPHZZ":
            warnings.warn( "EETauTree: Expected branch e2MVAIsoWPHZZ does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e2MVAIsoWPHZZ")
        else:
            self.e2MVAIsoWPHZZ_branch.SetAddress(<void*>&self.e2MVAIsoWPHZZ_value)

        #print "making e2MVAIsoWPLoose"
        self.e2MVAIsoWPLoose_branch = the_tree.GetBranch("e2MVAIsoWPLoose")
        #if not self.e2MVAIsoWPLoose_branch and "e2MVAIsoWPLoose" not in self.complained:
        if not self.e2MVAIsoWPLoose_branch and "e2MVAIsoWPLoose":
            warnings.warn( "EETauTree: Expected branch e2MVAIsoWPLoose does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e2MVAIsoWPLoose")
        else:
            self.e2MVAIsoWPLoose_branch.SetAddress(<void*>&self.e2MVAIsoWPLoose_value)
        ...
        #print "making e2MVANoisoWPLoose"
        self.e2MVANoisoWPLoose_branch = the_tree.GetBranch("e2MVANoisoWPLoose")
        #if not self.e2MVANoisoWPLoose_branch and "e2MVANoisoWPLoose" not in self.complained:
        if not self.e2MVANoisoWPLoose_branch and "e2MVANoisoWPLoose":
            warnings.warn( "EETauTree: Expected branch e2MVANoisoWPLoose does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e2MVANoisoWPLoose")
        else:
            self.e2MVANoisoWPLoose_branch.SetAddress(<void*>&self.e2MVANoisoWPLoose_value)
        ...
        #print "making e2ZTTGenDR"
        self.e2ZTTGenDR_branch = the_tree.GetBranch("e2ZTTGenDR")
        #if not self.e2ZTTGenDR_branch and "e2ZTTGenDR" not in self.complained:
        if not self.e2ZTTGenDR_branch and "e2ZTTGenDR":
            warnings.warn( "EETauTree: Expected branch e2ZTTGenDR does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e2ZTTGenDR")
        else:
            self.e2ZTTGenDR_branch.SetAddress(<void*>&self.e2ZTTGenDR_value)

        #print "making e2ZTTGenEta"
        self.e2ZTTGenEta_branch = the_tree.GetBranch("e2ZTTGenEta")
        #if not self.e2ZTTGenEta_branch and "e2ZTTGenEta" not in self.complained:
        if not self.e2ZTTGenEta_branch and "e2ZTTGenEta":
            warnings.warn( "EETauTree: Expected branch e2ZTTGenEta does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e2ZTTGenEta")
        else:
            self.e2ZTTGenEta_branch.SetAddress(<void*>&self.e2ZTTGenEta_value)
        ...
        #print "making e2ZTTGenPhi"
        self.e2ZTTGenPhi_branch = the_tree.GetBranch("e2ZTTGenPhi")
        #if not self.e2ZTTGenPhi_branch and "e2ZTTGenPhi" not in self.complained:
        if not self.e2ZTTGenPhi_branch and "e2ZTTGenPhi":
            warnings.warn( "EETauTree: Expected branch e2ZTTGenPhi does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e2ZTTGenPhi")
        else:
            self.e2ZTTGenPhi_branch.SetAddress(<void*>&self.e2ZTTGenPhi_value)

        #print "making e2ZTTGenPt"
        self.e2ZTTGenPt_branch = the_tree.GetBranch("e2ZTTGenPt")
        #if not self.e2ZTTGenPt_branch and "e2ZTTGenPt" not in self.complained:
        if not self.e2ZTTGenPt_branch and "e2ZTTGenPt":
            warnings.warn( "EETauTree: Expected branch e2ZTTGenPt does not exist!"                " It will crash if you try and use it!",Warning)
            #self.complained.add("e2ZTTGenPt")
        else:
            self.e2ZTTGenPt_branch.SetAddress(<void*>&self.e2ZTTGenPt_value)
        ...
        if not self.eVetoHZZPt5_branch and "eVetoHZZPt5":
            warnings.warn( "EETauTree: Expected branch eVetoHZZPt5 does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.muVeto5_branch and "muVeto5":
            warnings.warn( "EETauTree: Expected branch muVeto5 does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tDeepTau2017v1VSeraw_branch and "tDeepTau2017v1VSeraw":
            warnings.warn( "EETauTree: Expected branch tDeepTau2017v1VSeraw does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tDeepTau2017v1VSjetraw_branch and "tDeepTau2017v1VSjetraw":
            warnings.warn( "EETauTree: Expected branch tDeepTau2017v1VSjetraw does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tDeepTau2017v1VSmuraw_branch and "tDeepTau2017v1VSmuraw":
            warnings.warn( "EETauTree: Expected branch tDeepTau2017v1VSmuraw does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tLooseDeepTau2017v1VSe_branch and "tLooseDeepTau2017v1VSe":
            warnings.warn( "EETauTree: Expected branch tLooseDeepTau2017v1VSe does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tLooseDeepTau2017v1VSjet_branch and "tLooseDeepTau2017v1VSjet":
            warnings.warn( "EETauTree: Expected branch tLooseDeepTau2017v1VSjet does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tLooseDeepTau2017v1VSmu_branch and "tLooseDeepTau2017v1VSmu":
            warnings.warn( "EETauTree: Expected branch tLooseDeepTau2017v1VSmu does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tMatchesDoubleMediumCombinedIsoTau35Path_branch and "tMatchesDoubleMediumCombinedIsoTau35Path":
            warnings.warn( "EETauTree: Expected branch tMatchesDoubleMediumCombinedIsoTau35Path does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tMatchesDoubleMediumHPSTau35Filter_branch and "tMatchesDoubleMediumHPSTau35Filter":
            warnings.warn( "EETauTree: Expected branch tMatchesDoubleMediumHPSTau35Filter does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tMatchesDoubleMediumHPSTau35Path_branch and "tMatchesDoubleMediumHPSTau35Path":
            warnings.warn( "EETauTree: Expected branch tMatchesDoubleMediumHPSTau35Path does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tMatchesDoubleMediumHPSTau40Filter_branch and "tMatchesDoubleMediumHPSTau40Filter":
            warnings.warn( "EETauTree: Expected branch tMatchesDoubleMediumHPSTau40Filter does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tMatchesDoubleMediumHPSTau40Path_branch and "tMatchesDoubleMediumHPSTau40Path":
            warnings.warn( "EETauTree: Expected branch tMatchesDoubleMediumHPSTau40Path does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tMatchesDoubleMediumIsoTau35Path_branch and "tMatchesDoubleMediumIsoTau35Path":
            warnings.warn( "EETauTree: Expected branch tMatchesDoubleMediumIsoTau35Path does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tMatchesDoubleMediumTau35Filter_branch and "tMatchesDoubleMediumTau35Filter":
            warnings.warn( "EETauTree: Expected branch tMatchesDoubleMediumTau35Filter does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tMatchesDoubleMediumTau35Path_branch and "tMatchesDoubleMediumTau35Path":
            warnings.warn( "EETauTree: Expected branch tMatchesDoubleMediumTau35Path does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tMatchesDoubleMediumTau40Filter_branch and "tMatchesDoubleMediumTau40Filter":
            warnings.warn( "EETauTree: Expected branch tMatchesDoubleMediumTau40Filter does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tMatchesDoubleMediumTau40Path_branch and "tMatchesDoubleMediumTau40Path":
            warnings.warn( "EETauTree: Expected branch tMatchesDoubleMediumTau40Path does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tMatchesDoubleTightHPSTau35Filter_branch and "tMatchesDoubleTightHPSTau35Filter":
            warnings.warn( "EETauTree: Expected branch tMatchesDoubleTightHPSTau35Filter does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tMatchesDoubleTightHPSTau35Path_branch and "tMatchesDoubleTightHPSTau35Path":
            warnings.warn( "EETauTree: Expected branch tMatchesDoubleTightHPSTau35Path does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tMatchesDoubleTightHPSTau40Filter_branch and "tMatchesDoubleTightHPSTau40Filter":
            warnings.warn( "EETauTree: Expected branch tMatchesDoubleTightHPSTau40Filter does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tMatchesDoubleTightHPSTau40Path_branch and "tMatchesDoubleTightHPSTau40Path":
            warnings.warn( "EETauTree: Expected branch tMatchesDoubleTightHPSTau40Path does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tMatchesDoubleTightTau35Filter_branch and "tMatchesDoubleTightTau35Filter":
            warnings.warn( "EETauTree: Expected branch tMatchesDoubleTightTau35Filter does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tMatchesDoubleTightTau35Path_branch and "tMatchesDoubleTightTau35Path":
            warnings.warn( "EETauTree: Expected branch tMatchesDoubleTightTau35Path does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tMatchesDoubleTightTau40Filter_branch and "tMatchesDoubleTightTau40Filter":
            warnings.warn( "EETauTree: Expected branch tMatchesDoubleTightTau40Filter does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tMatchesDoubleTightTau40Path_branch and "tMatchesDoubleTightTau40Path":
            warnings.warn( "EETauTree: Expected branch tMatchesDoubleTightTau40Path does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tMediumDeepTau2017v1VSe_branch and "tMediumDeepTau2017v1VSe":
            warnings.warn( "EETauTree: Expected branch tMediumDeepTau2017v1VSe does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tMediumDeepTau2017v1VSjet_branch and "tMediumDeepTau2017v1VSjet":
            warnings.warn( "EETauTree: Expected branch tMediumDeepTau2017v1VSjet does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tMediumDeepTau2017v1VSmu_branch and "tMediumDeepTau2017v1VSmu":
            warnings.warn( "EETauTree: Expected branch tMediumDeepTau2017v1VSmu does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tTightDeepTau2017v1VSe_branch and "tTightDeepTau2017v1VSe":
            warnings.warn( "EETauTree: Expected branch tTightDeepTau2017v1VSe does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tTightDeepTau2017v1VSjet_branch and "tTightDeepTau2017v1VSjet":
            warnings.warn( "EETauTree: Expected branch tTightDeepTau2017v1VSjet does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tTightDeepTau2017v1VSmu_branch and "tTightDeepTau2017v1VSmu":
            warnings.warn( "EETauTree: Expected branch tTightDeepTau2017v1VSmu does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tVLooseDeepTau2017v1VSe_branch and "tVLooseDeepTau2017v1VSe":
            warnings.warn( "EETauTree: Expected branch tVLooseDeepTau2017v1VSe does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tVLooseDeepTau2017v1VSjet_branch and "tVLooseDeepTau2017v1VSjet":
            warnings.warn( "EETauTree: Expected branch tVLooseDeepTau2017v1VSjet does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tVLooseDeepTau2017v1VSmu_branch and "tVLooseDeepTau2017v1VSmu":
            warnings.warn( "EETauTree: Expected branch tVLooseDeepTau2017v1VSmu does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tVTightDeepTau2017v1VSe_branch and "tVTightDeepTau2017v1VSe":
            warnings.warn( "EETauTree: Expected branch tVTightDeepTau2017v1VSe does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tVTightDeepTau2017v1VSjet_branch and "tVTightDeepTau2017v1VSjet":
            warnings.warn( "EETauTree: Expected branch tVTightDeepTau2017v1VSjet does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tVTightDeepTau2017v1VSmu_branch and "tVTightDeepTau2017v1VSmu":
            warnings.warn( "EETauTree: Expected branch tVTightDeepTau2017v1VSmu does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tVVLooseDeepTau2017v1VSe_branch and "tVVLooseDeepTau2017v1VSe":
            warnings.warn( "EETauTree: Expected branch tVVLooseDeepTau2017v1VSe does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tVVLooseDeepTau2017v1VSjet_branch and "tVVLooseDeepTau2017v1VSjet":
            warnings.warn( "EETauTree: Expected branch tVVLooseDeepTau2017v1VSjet does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tVVLooseDeepTau2017v1VSmu_branch and "tVVLooseDeepTau2017v1VSmu":
            warnings.warn( "EETauTree: Expected branch tVVLooseDeepTau2017v1VSmu does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tVVTightDeepTau2017v1VSe_branch and "tVVTightDeepTau2017v1VSe":
            warnings.warn( "EETauTree: Expected branch tVVTightDeepTau2017v1VSe does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tVVTightDeepTau2017v1VSjet_branch and "tVVTightDeepTau2017v1VSjet":
            warnings.warn( "EETauTree: Expected branch tVVTightDeepTau2017v1VSjet does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tVVTightDeepTau2017v1VSmu_branch and "tVVTightDeepTau2017v1VSmu":
            warnings.warn( "EETauTree: Expected branch tVVTightDeepTau2017v1VSmu does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tVVVLooseDeepTau2017v1VSe_branch and "tVVVLooseDeepTau2017v1VSe":
            warnings.warn( "EETauTree: Expected branch tVVVLooseDeepTau2017v1VSe does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tVVVLooseDeepTau2017v1VSjet_branch and "tVVVLooseDeepTau2017v1VSjet":
            warnings.warn( "EETauTree: Expected branch tVVVLooseDeepTau2017v1VSjet does not exist!"                " It will crash if you try and use it!",Warning)
        ...
        if not self.tVVVLooseDeepTau2017v1VSmu_branch and "tVVVLooseDeepTau2017v1VSmu":
            warnings.warn( "EETauTree: Expected branch tVVVLooseDeepTau2017v1VSmu does not exist!"                " It will crash if you try and use it!",Warning)
    ...
    property e1MVAIsoWPHZZ:
        def __get__(self):
            self.e1MVAIsoWPHZZ_branch.GetEntry(self.localentry, 0)
            return self.e1MVAIsoWPHZZ_value

    property e1MVAIsoWPLoose:
        def __get__(self):
            self.e1MVAIsoWPLoose_branch.GetEntry(self.localentry, 0)
            return self.e1MVAIsoWPLoose_value
    ...
    property e1MVANoisoWPLoose:
        def __get__(self):
            self.e1MVANoisoWPLoose_branch.GetEntry(self.localentry, 0)
            return self.e1MVANoisoWPLoose_value
    ...
    property e1ZTTGenDR:
        def __get__(self):
            self.e1ZTTGenDR_branch.GetEntry(self.localentry, 0)
            return self.e1ZTTGenDR_value

    property e1ZTTGenEta:
        def __get__(self):
            self.e1ZTTGenEta_branch.GetEntry(self.localentry, 0)
            return self.e1ZTTGenEta_value
    ...
    property e1ZTTGenPhi:
        def __get__(self):
            self.e1ZTTGenPhi_branch.GetEntry(self.localentry, 0)
            return self.e1ZTTGenPhi_value

    property e1ZTTGenPt:
        def __get__(self):
            self.e1ZTTGenPt_branch.GetEntry(self.localentry, 0)
            return self.e1ZTTGenPt_value
    ...
    property e2MVAIsoWPHZZ:
        def __get__(self):
            self.e2MVAIsoWPHZZ_branch.GetEntry(self.localentry, 0)
            return self.e2MVAIsoWPHZZ_value

    property e2MVAIsoWPLoose:
        def __get__(self):
            self.e2MVAIsoWPLoose_branch.GetEntry(self.localentry, 0)
            return self.e2MVAIsoWPLoose_value
    ...
    property e2MVANoisoWPLoose:
        def __get__(self):
            self.e2MVANoisoWPLoose_branch.GetEntry(self.localentry, 0)
            return self.e2MVANoisoWPLoose_value
    ...
    property e2ZTTGenDR:
        def __get__(self):
            self.e2ZTTGenDR_branch.GetEntry(self.localentry, 0)
            return self.e2ZTTGenDR_value

    property e2ZTTGenEta:
        def __get__(self):
            self.e2ZTTGenEta_branch.GetEntry(self.localentry, 0)
            return self.e2ZTTGenEta_value
    ...
    property e2ZTTGenPhi:
        def __get__(self):
            self.e2ZTTGenPhi_branch.GetEntry(self.localentry, 0)
            return self.e2ZTTGenPhi_value

    property e2ZTTGenPt:
        def __get__(self):
            self.e2ZTTGenPt_branch.GetEntry(self.localentry, 0)
            return self.e2ZTTGenPt_value
