...
class AnalyzeMuTauSys(MegaBase):
  ...
  def begin(self):
    ...
    sys = ['', 'puUp', 'puDown', 'trUp', 'trDown', 'scaletDM0Up', 'scaletDM0Down', 'scaletDM1Up', 'scaletDM1Down', 'scaletDM10Up', 'scaletDM10Down', 'mesUp', 'mesDown', 'UnclusteredEnDown', 'UnclusteredEnUp', 'JetResUp', 'JetResDown', 'JetEnUp', 'JetEnDown']
  ...
  def fill_sys(self, row, weight, name=''):
    if self.is_mc:
      ...
      mesrow = self.deepcopyrow(row)
      mesrow['mPt'] = mesrow['mPt_MuonEnUp']
      self.fill_histos(mesrow, weight, name+'/mesUp')
      mesrow['mPt'] = mesrow['mPt_MuonEnDown']
      ...
      uesrow['type1_pfMetEt'] = self.metTauC(uesrow['tPt'], uesrow['tDecayMode'], uesrow['tZTTGenMatching'], uesrow['type1_pfMet_shiftedPt_UnclusteredEnDown'])
      ...
      jesrow = self.deepcopyrow(row)
      jesrow['type1_pfMetEt'] = self.metTauC(jesrow['tPt'], jesrow['tDecayMode'], jesrow['tZTTGenMatching'], jesrow['type1_pfMet_shiftedPt_JetEnUp'])
      jesrow['type1_pfMetPhi'] = jesrow['type1_pfMet_shiftedPhi_JetEnUp']
      self.fill_histos(jesrow, weight, name+'/JetEnUp')
      jesrow['type1_pfMetEt'] = self.metTauC(jesrow['tPt'], jesrow['tDecayMode'], jesrow['tZTTGenMatching'], jesrow['type1_pfMet_shiftedPt_JetEnDown'])
      jesrow['type1_pfMetPhi'] = jesrow['type1_pfMet_shiftedPhi_JetEnDown']
      self.fill_histos(jesrow, weight, name+'/JetEnDown')
      jesrow['type1_pfMetEt'] = self.metTauC(jesrow['tPt'], jesrow['tDecayMode'], jesrow['tZTTGenMatching'], jesrow['type1_pfMet_shiftedPt_JetResUp'])
      jesrow['type1_pfMetPhi'] = jesrow['type1_pfMet_shiftedPhi_JetResUp']
      self.fill_histos(jesrow, weight, name+'/JetResUp')
      jesrow['type1_pfMetEt'] = self.metTauC(jesrow['tPt'], jesrow['tDecayMode'], jesrow['tZTTGenMatching'], jesrow['type1_pfMet_shiftedPt_JetResDown'])
      jesrow['type1_pfMetPhi'] = jesrow['type1_pfMet_shiftedPhi_JetResDown']
      self.fill_histos(jesrow, weight, name+'/JetResDown')
      if name=='TauLooseOS' or name=='TauLooseOS0Jet' or name=='TauLooseOS1Jet' or name=='TauLooseOS2Jet' or name=='TauLooseOS2JetVBF' or name=='MuonLooseTauLooseOS' or name=='MuonLooseTauLooseOS0Jet' or name=='MuonLooseTauLooseOS1Jet' or name=='MuonLooseTauLooseOS2Jet' or name=='MuonLooseTauLooseOS2JetVBF':
      ...
      if name=='MuonLooseOS' or name=='MuonLooseOS0Jet' or name=='MuonLooseOS1Jet' or name=='MuonLooseOS2Jet' or name=='MuonLooseOS2JetVBF' or name=='MuonLooseTauLooseOS' or name=='MuonLooseTauLooseOS0Jet' or name=='MuonLooseTauLooseOS1Jet' or name=='MuonLooseTauLooseOS2Jet' or name=='MuonLooseTauLooseOS2JetVBF':
        myrand = random.random()
        if myrand < 0.5:
          weightDown = self.fakeRateMuon(row['mPt'], 'frDown') * weight/self.fakeRateMuon(row['mPt'])
          self.fill_histos(row, weightDown, name+'/MuonFakeDown')
          self.fill_histos(row, weight, name+'/MuonFakeUp')
        else:
  ...
  def deepcopyrow(self, row):
    ...
    if self.is_mc:
      ...
      subtemp["type1_pfMet_shiftedPhi_JetEnDown"] = row["type1_pfMet_shiftedPhi_JetEnDown"]
      subtemp["type1_pfMet_shiftedPhi_JetEnUp"] = row["type1_pfMet_shiftedPhi_JetEnUp"]
      subtemp["type1_pfMet_shiftedPhi_JetResDown"] = row["type1_pfMet_shiftedPhi_JetResDown"]
      subtemp["type1_pfMet_shiftedPhi_JetResUp"] = row["type1_pfMet_shiftedPhi_JetResUp"]
      ...
      subtemp["type1_pfMet_shiftedPt_JetEnDown"] = row["type1_pfMet_shiftedPt_JetEnDown"]
      subtemp["type1_pfMet_shiftedPt_JetEnUp"] = row["type1_pfMet_shiftedPt_JetEnUp"]
      subtemp["type1_pfMet_shiftedPt_JetResDown"] = row["type1_pfMet_shiftedPt_JetResDown"]
      subtemp["type1_pfMet_shiftedPt_JetResUp"] = row["type1_pfMet_shiftedPt_JetResUp"]
