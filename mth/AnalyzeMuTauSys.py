...
class AnalyzeMuTauSys(MegaBase):
  ...
  def begin(self):
    ...
    loosenames = ['TauLooseOS', 'MuonLooseOS', 'MuonLooseTauLooseOS', 'TauLooseOS0Jet', 'MuonLooseOS0Jet', 'MuonLooseTauLooseOS0Jet', 'TauLooseOS1Jet', 'MuonLooseOS1Jet', 'MuonLooseTauLooseOS1Jet']
    vbfnames = ['TightOS2Jet', 'TightOS2JetVBF']
    loosevbfnames = ['TauLooseOS2Jet', 'MuonLooseOS2Jet', 'MuonLooseTauLooseOS2Jet', 'TauLooseOS2JetVBF', 'MuonLooseOS2JetVBF', 'MuonLooseTauLooseOS2JetVBF']
