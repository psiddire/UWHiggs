...
# File
#f = ROOT.TFile.Open('shapesMTBDT.root', 'READ')
f = ROOT.TFile.Open('shapesMT.root', 'READ')

#fNew = ROOT.TFile.Open('NewShapes/shapesMTBDT.root', 'RECREATE')
fNew = ROOT.TFile.Open('NewShapes/shapesMT.root', 'RECREATE')
