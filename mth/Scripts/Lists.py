...
mcSys = ['/puUp', '/puDown', '/pfUp', '/pfDown', '/tidUp', '/tidDown', '/bTagUp', '/bTagDown', '/mtfakeUp', '/mtfakeDown', '/etfakeUp', '/etfakeDown', '/etefakeUp', '/etefakeDown', '/mesUp', '/mesDown']
...
mc_samples = ['DYJetsToLL_M-50*', 'DYJetsToLL_M-10to50*', 'DY1JetsToLL*', 'DY2JetsToLL*', 'DY3JetsToLL*', 'DY4JetsToLL*', 'GluGlu_LFV*', 'VBF_LFV*', 'GluGluHToTauTau*', 'VBFHToTauTau*', 'GluGluHToWWTo2L2Nu*', 'VBFHToWWTo2L2Nu*', 'WminusHToTauTau*', 'WplusHToTauTau*', 'ZHToTauTau*', 'TT*', 'ST_tW_antitop*', 'ST_tW_top*', 'ST_t-channel_antitop*', 'ST_t-channel_top*', 'QCD*', 'WZ*', 'WW*', 'ZZ*', 'EWKWMinus2Jets*', 'EWKWPlus2Jets*', 'EWKZ2Jets_ZToLL*', 'EWKZ2Jets_ZToNuNu*', 'Embed*', 'MC*', 'data*']

mc_samples_W = mc_samples + ['WJetsToLNu*', 'W1JetsToLNu*', 'W2JetsToLNu*', 'W3JetsToLNu*', 'W4JetsToLNu*']

histoname = [("mPt", "#mu p_{T} (GeV)", 1), ("tPt", "#tau p_{T} (GeV)", 1), ("mEta", "#mu #eta", 1), ("tEta", "#tau #eta", 1), ("mPhi", "#mu #phi", 1), ("tPhi", "#tau #phi", 1), ("type1_pfMetEt", "MET (GeV)", 1), ("type1_pfMetPhi", "MET #phi", 1), ("j1Pt", "Jet 1 p_{T}", 1), ("j2Pt", "Jet 2 p_{T}", 1), ("j1Eta", "Jet 1 #eta", 1), ("j2Eta", "Jet 2 #eta", 1), ("j1Phi", "Jet 1 #phi", 1), ("j2Phi", "Jet 2 #phi", 1), ("m_t_Mass", "M_{vis}(#mu, #tau) (GeV)", 1), ("m_t_CollMass", "M_{col}(#mu, #tau) (GeV)", 1), ("m_t_PZeta", "p_{#zeta}(#mu, #tau) (GeV)", 1), ("numOfJets", "Number Of Jets", 1), ("numOfVtx", "Number of Vertices", 1), ("vbfMass", "VBF Mass", 1), ("dEtaMuTau", "#Delta#eta(#mu, #tau)", 1), ("dPhiMuMET", "#Delta#phi(#mu, MET)", 1), ("dPhiTauMET", "#Delta#phi(#tau, MET)", 1), ("dPhiMuTau", "#Delta#phi(#mu, #tau)", 1), ("MTMuMET", "M_{T}(#mu, MET) (GeV)", 1), ("MTTauMET", "M_{T}(#tau, MET) (GeV)", 1)]
