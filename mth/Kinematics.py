...
var_d_star = ['mPt', 'tPt', 'dPhiMuTau', 'dEtaMuTau', 'type1_pfMetEt', 'm_t_collinearMass', 'MTTauMET', 'dPhiTauMET', 'njets', 'vbfMass']
xml_name = os.path.join(os.getcwd(), 'bdtdata/dataset/weights/TMVAClassification_BDT.weights.xml')
functor = FunctorFromMVACat('BDT method', xml_name, *var_d_star)

def var_d(myMuon, myMET, myTau, njets, mjj):
