...
class AnalyzeMuTau(MegaBase, MuTauBase):
  ...
  def fill_histos_gen(self, row, myMuon, myMET, myTau, weight, name):
    ...
    if not self.oppositesign(row):
      ...
      if njets==0:
        self.fill_histos(row, myMuon, myMET, myTau, weight, name[2]+'0Jet')
      elif njets==1:
        self.fill_histos(row, myMuon, myMET, myTau, weight, name[2]+'1Jet')
      elif njets==2 and mjj < 550:
        self.fill_histos(row, myMuon, myMET, myTau, weight, name[2]+'2Jet')
      elif njets==2 and mjj > 550:
        self.fill_histos(row, myMuon, myMET, myTau, weight, name[2]+'2JetVBF')
