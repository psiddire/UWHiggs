class mcWeights:
    def __init__(self, target):
        ...
        self.is_recoilC = bool(self.is_DYlow or self.is_DY or self.is_GluGlu or self.is_VBF or self.is_VBFH or self.is_GluGluH or self.is_VBFHWW or self.is_GluGluHWW or self.is_W)
        #self.is_recoilC = bool(self.is_DYlow or self.is_DY)
        self.DYweight = {
            0 : 2.669220533,#/1.165,
            1 : 0.733821351,
            2 : 0.955182549,
    ...
    def lumiWeight(self, weight): 
        ...
        if self.is_WW:
            weight = weight*0.638#*0.407
        if self.is_WZ:
            weight = weight*0.502#*0.294
        if self.is_ZZ:
            weight = weight*0.355#*0.261
