...
fe = ROOT.TFile("../../FinalStateAnalysis/TagAndProbe/data/2017/htt_scalefactors_v17_5.root")
we = fe.Get("w")

f6 = ROOT.TFile("../../FinalStateAnalysis/TagAndProbe/data/2017/htt_scalefactors_v17_6.root")
w6 = f6.Get("w")

fpt = ROOT.TFile("../../FinalStateAnalysis/TagAndProbe/data/2017/MuTauEmbedPt.root")
wpt0 = fpt.Get("0Jet")
wpt1 = fpt.Get("1Jet")
wpt2 = fpt.Get("2Jet")
