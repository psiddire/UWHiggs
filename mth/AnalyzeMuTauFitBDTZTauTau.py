...
class AnalyzeMuTauFitBDTZTauTau(MegaBase):
  ...
  def __init__(self, tree, outfile, **kwargs):
    ...
    super(AnalyzeMuTauFitBDTZTauTau, self).__init__(tree, outfile, **kwargs)
  ...
  def process(self):
    ...
    for row in self.tree:
      ...
      if visibleMass(newrow) < 40 or visibleMass(newrow) > 80:
        continue
