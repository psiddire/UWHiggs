...
int TMVAClassification( TString myMethodList = "" )
{
  ...
  dataloader->AddVariable("tPt", 'F');
  dataloader->AddVariable("dPhiETau", 'F');
  dataloader->AddVariable("dEtaETau", 'F');
  dataloader->AddVariable("e_t_collinearMass", 'F');
  dataloader->AddVariable("e_t_visibleMass", 'F');
  dataloader->AddVariable("MTTauMET", 'F');
  dataloader->AddVariable("dPhiTauMET", 'F');
