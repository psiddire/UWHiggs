...
againstEle = TauPOGCorrections.make_tau_pog_againstElectron_2016('Tight')
deepTauVSmu = TauPOGCorrections.make_tau_pog_DeepTauVSmu_2016('Loose')
againstMu = TauPOGCorrections.make_tau_pog_againstMuon_2016('Loose')
...
feta = ROOT.TFile("../../FinalStateAnalysis/TagAndProbe/data/2016/ETauEmbedEta.root")
weta0 = feta.Get("0Jet")
weta1 = feta.Get("1Jet")
weta2 = feta.Get("2Jet")
...
fphi = ROOT.TFile("../../FinalStateAnalysis/TagAndProbe/data/2016/ETauEmbedPhi.root")
wphi0 = fphi.Get("0Jet")
wphi1 = fphi.Get("1Jet")
wphi2 = fphi.Get("2Jet")
