...
varnames['dPhiETau']='#Delta#phi[e, #tau]'
varnames['dEtaETau']='#Delta#eta[e, #tau]'
varnames['dPhiTauMET']='#Delta#phi[#tau, MET]'
varnames['e_t_CollinearMass']='M_{col} [GeV]'
varnames['e_t_Mass']='M_{vis} [GeV]'
varnames['MTTauMET']='M_{T}[#tau, MET] [GeV]'
varnames['j1Pt']='Jet 1 p_{T} [GeV]'
varnames['j2Pt']='Jet 2 p_{T} [GeV]'
varnames['dRETau']='#Delta R[e, #tau]'
