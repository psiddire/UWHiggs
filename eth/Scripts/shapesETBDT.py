...
for di in Lists.dirs:
    ...
    if di=='0Jet':
        ...
        dr = '1jet'
        binning = array.array('d', [-1.0, -0.6, -0.45, -0.4, -0.35, -0.3, -0.25, -0.2, -0.15, -0.1, -0.05, 0.0, 0.05, 0.1, 0.15, 0.2, 0.35, 1.0])
    elif di=='2Jet':
        dr = '2jet_gg'
        binning = array.array('d', [-1.0, -0.55, -0.45, -0.4, -0.35, -0.3, -0.25, -0.2, -0.15, -0.1, -0.05, 0.0, 0.05, 0.1, 0.15, 0.2, 0.35, 1.0])
    else:
        dr = '2jet_vbf'
        binning = array.array('d', [-1.0, -0.6, -0.4, -0.3, -0.2, -0.1, 0.0, 0.1, 0.2, 0.35, 1.0])
    ...
    # Trigger and Electron Energy Scale
