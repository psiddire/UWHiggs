...
for j in jet:
    ...
    outputdir = 'plots/%s/AnalyzeETau/2016SelectionsEmbedDYPtNewNew/%s/' % (jobid, s1)
    ...
    vbfHET = views.TitleView(vbfHET, "LFV ggH (B=20%)")
    ...
    ggHET = views.TitleView(ggHET, "LFV qqH (B=20%)")
