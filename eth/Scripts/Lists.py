...
eleFR = ['/EleFakep0Up', '/EleFakep0Down', '/EleFakep1Up', '/EleFakep1Down', '/EleFakep2Up', '/EleFakep2Down']
...
sigSys = ['/puUp', '/puDown', '/pfUp', '/pfDown', '/tidUp', '/tidDown', '/recrespUp', '/recrespDown', '/recresoUp', '/recresoDown', '/mtfakeUp', '/mtfakeDown', '/etfakeUp', '/etfakeDown', '/etefakeUp', '/etefakeDown', '/scaletDM0Up', '/scaletDM0Down', '/scaletDM1Up', '/scaletDM1Down', '/scaletDM10Up', '/scaletDM10Down', '/eesUp', '/eesDown']

sigSysNames = ['_CMS_Pileup_13TeVUp', '_CMS_Pileup_13TeVDown', '_CMS_Prefiring_13TeVUp', '_CMS_Prefiring_13TeVDown', '_CMS_eff_tauUp', '_CMS_eff_tauDown', '_CMS_RecoilResponse_13TeVUp', '_CMS_RecoilResponse_13TeVDown', '_CMS_RecoilResolution_13TeVUp', '_CMS_RecoilResolution_13TeVDown', '_CMS_scale_mfaketau_13TeVUp', '_CMS_scale_mfaketau_13TeVDown', '_CMS_scale_efaketau_13TeVUp', '_CMS_scale_efaketau_13TeVDown', '_CMS_scale_efaketaues_13TeVUp', '_CMS_scale_efaketaues_13TeVDown', '_CMS_scale_t_1prong_13TeVUp', '_CMS_scale_t_1prong_13TeVDown', '_CMS_scale_t_1prong1pizero_13TeVUp', '_CMS_scale_t_1prong1pizero_13TeVDown', '_CMS_scale_t_3prong_13TeVUp', '_CMS_scale_t_3prong_13TeVDown', '_CMS_EES_13TeVUp', '_CMS_EES_13TeVDown']

bacSys = ['/puUp', '/puDown', '/pfUp', '/pfDown', '/tidUp', '/tidDown', '/mtfakeUp', '/mtfakeDown', '/etfakeUp', '/etfakeDown', '/etefakeUp', '/etefakeDown', '/scaletDM0Up', '/scaletDM0Down', '/scaletDM1Up', '/scaletDM1Down', '/scaletDM10Up', '/scaletDM10Down', '/eesUp', '/eesDown']

bacSysNames = ['_CMS_Pileup_13TeVUp', '_CMS_Pileup_13TeVDown', '_CMS_Prefiring_13TeVUp', '_CMS_Prefiring_13TeVDown', '_CMS_eff_tauUp', '_CMS_eff_tauDown', '_CMS_scale_mfaketau_13TeVUp', '_CMS_scale_mfaketau_13TeVDown', '_CMS_scale_efaketau_13TeVUp', '_CMS_scale_efaketau_13TeVDown', '_CMS_scale_efaketaues_13TeVUp', '_CMS_scale_efaketaues_13TeVDown', '_CMS_scale_t_1prong_13TeVUp', '_CMS_scale_t_1prong_13TeVDown', '_CMS_scale_t_1prong1pizero_13TeVUp', '_CMS_scale_t_1prong1pizero_13TeVDown', '_CMS_scale_t_3prong_13TeVUp', '_CMS_scale_t_3prong_13TeVDown', '_CMS_EES_13TeVUp', '_CMS_EES_13TeVDown']
