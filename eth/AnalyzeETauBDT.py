...
class AnalyzeETauBDT(MegaBase):
  ...
  def __init__(self, tree, outfile, **kwargs):
    ...
    self.branches="ePt/F:tPt/F:dPhiETau/F:dEtaETau/F:e_t_collinearMass/F:e_t_visibleMass/F:MTTauMET/F:dPhiTauMET/F:type1_pfMetEt/F:njets/I:vbfMass/F:weight/F"
    self.holders = []
