...
class getTauTriggerSFs :
    ...
    def __init__( self, trigger='etau', year=2018, tauWP='tight', wpType='MVAv2' ):
        ...
        self.f = ROOT.TFile( '../../FinalStateAnalysis/TagAndProbe/data/2018/tauTriggerEfficiencies2018.root', 'r' )
