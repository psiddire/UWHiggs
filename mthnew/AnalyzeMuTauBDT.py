...
class AnalyzeMuTauBDT(MegaBase):
  ...
  def __init__(self, tree, outfile, **kwargs):
    ...
    self.branches="mPt/F:tPt/F:dPhiMuTau/F:dEtaMuTau/F:type1_pfMetEt/F:m_t_collinearMass/F:MTTauMET/F:dPhiTauMET/F:weight/F"#vbfMass/F:vbfDeta/F
    self.holders = []
  ...
  def process(self):
    ...
    for row in self.tree:
      ...
      if newrow['vbfNJets30']!=2 or newrow['vbfNJets30']!=0:
        continue
