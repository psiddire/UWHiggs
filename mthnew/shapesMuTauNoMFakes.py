...
f = ROOT.TFile( 'shapesMuTauNoMFakes.root', 'RECREATE')
...
for di in dirs:
    ...
    qcd.SetName('Fakes')
    tfakes = QCD.Get("m_t_CollinearMass")
    tfakesup = QCD.Get("TauFakeUp/m_t_CollinearMass")
    tfakesdown = QCD.Get("TauFakeDown/m_t_CollinearMass")
