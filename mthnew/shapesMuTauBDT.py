...
f = ROOT.TFile( 'shapesMuTauBDT.root', 'RECREATE')
...
for di in dirs:
    ...
    qcd.SetName('Fakes')
    mfakes = fakesMuon.Get("bdtDiscriminator")
    tfakes = fakesTau.Get("bdtDiscriminator")
    mtfakes = fakesTauMuon.Get("bdtDiscriminator")
    tfakesup = fakesTau.Get("TauFakeUp/bdtDiscriminator")
    tfakesdown = fakesTau.Get("TauFakeDown/bdtDiscriminator")
    mfakesup = fakesMuon.Get("MuonFakeUp/bdtDiscriminator")
    mfakesdown = fakesMuon.Get("MuonFakeDown/bdtDiscriminator")
    mttfakesup = fakesTauMuon.Get("TauFakeUp/bdtDiscriminator")
    mttfakesdown = fakesTauMuon.Get("TauFakeDown/bdtDiscriminator")
    mtmfakesup = fakesTauMuon.Get("MuonFakeUp/bdtDiscriminator")
    mtmfakesdown = fakesTauMuon.Get("MuonFakeDown/bdtDiscriminator")
    f1 = tfakesup.Clone()
    f1.add(mfakes)
    f1.add(mttfakesup, -1)
    f1 = positivize(f1)
