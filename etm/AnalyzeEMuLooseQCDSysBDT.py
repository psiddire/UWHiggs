...
class AnalyzeEMuLooseQCDSysBDT(MegaBase):
  ...
  def __init__(self, tree, outfile, **kwargs):
    ...
    self.var_d_star = ['mPt', 'ePt', 'e_m_collinearMass', 'e_m_visibleMass', 'dPhiMuMET', 'dPhiEMET', 'dPhiEMu', 'MTMuMET']
    ...
    super(AnalyzeEMuLooseQCDSysBDT, self).__init__(tree, outfile, **kwargs)
  ...
  def var_d(self, myEle, myMET, myMuon):
