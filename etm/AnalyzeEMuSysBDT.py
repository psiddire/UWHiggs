  ...
  def fill_sys(self, row, myEle, myMET, myMuon, njets, weight):
    ...
    if self.is_mc:
      ...
      if self.is_recoilC and MetCorrection:
        ...
        self.fill_categories(myEle, tmpMET, myMuon, njets, mjj, weight, '/recrespUp')
        ...
        if sysMet!=None:
          tmpMET.SetPtEtaPhiM(math.sqrt(sysMet[0]*sysMet[0] + sysMet[1]*sysMet[1]), 0, math.atan2(sysMet[1], sysMet[0]), 0)
        self.fill_categories(myEle, tmpMET, myMuon, njets, mjj, weight, '/recrespDown')
        ...
        if sysMet!=None:
          tmpMET.SetPtEtaPhiM(math.sqrt(sysMet[0]*sysMet[0] + sysMet[1]*sysMet[1]), 0, math.atan2(sysMet[1], sysMet[0]), 0)
        self.fill_categories(myEle, tmpMET, myMuon, njets, mjj, weight, '/recresoUp')
        ...
        if sysMet!=None:
          tmpMET.SetPtEtaPhiM(math.sqrt(sysMet[0]*sysMet[0] + sysMet[1]*sysMet[1]), 0, math.atan2(sysMet[1], sysMet[0]), 0)
        self.fill_categories(myEle, tmpMET, myMuon, njets, mjj, weight, '/recresoDown')
      ...
      self.fill_categories(myEle, myMET, myMuon, njets, mjj, weight * 1.02, '/trUp')
      self.fill_categories(myEle, myMET, myMuon, njets, mjj, weight * 0.98, '/trDown')
      ...
      self.fill_categories(tmpEle, tmpMET, myMuon, njets, mjj, weight, '/eescUp')
      myMETpx = myMET.Px() + myEle.Px()
      myMETpy = myMET.Py() + myEle.Py()
      tmpEle.SetPtEtaPhiM(row.ePt, row.eEta, row.ePhi, row.eMass)
      ...
      myMETpy = myMETpy - tmpEle.Py()
      tmpMET.SetPxPyPzE(myMETpx, myMETpy, 0, math.sqrt(myMETpx * myMETpx + myMETpy * myMETpy))
      self.fill_categories(tmpEle, tmpMET, myMuon, njets, mjj, weight, '/eescDown')
      ...
      self.fill_categories(myEle, tmpMET, tmpMuon, njets, mjj, weight, '/mesUp')
      myMETpx = myMET.Px() + 0.002 * myMuon.Px()
      myMETpy = myMET.Py() + 0.002 * myMuon.Py()
      tmpMET.SetPxPyPzE(myMETpx, myMETpy, 0, math.sqrt(myMETpx * myMETpx + myMETpy * myMETpy))
      tmpMuon = myMuon * ROOT.Double(0.998)
      self.fill_categories(myEle, tmpMET, tmpMuon, njets, mjj, weight, '/mesDown')
      ...
      if self.is_TT:
        ...
        self.fill_categories(myEle, myMET, myMuon, njets, mjj, weight*topweight, '/TopptreweightUp')
        self.fill_categories(myEle, myMET, myMuon, njets, mjj, weight/topweight, '/TopptreweightDown')
