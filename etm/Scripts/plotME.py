...
for j in jet:
    ...
    outputdir = 'plots/%s/AnalyzeEMu/2016SelectionsEmbedEta/%s/' % (jobid, s1)
    ...
    histoname = [("mPt", "Muon  Pt (GeV)", 1),("ePt", "Electron Pt (Gev)", 1),("mEta", "Muon Eta", 1),("eEta", "Electron Eta", 1),("mPhi", "Muon Phi", 2),("ePhi", "Electron Phi", 1),("type1_pfMetEt", "Type1 MET Et", 1),("type1_pfMetPhi", "Type1 MET Phi", 1),("j2Pt", "Jet 2 Pt", 1),("j1Pt", "Jet 1 Pt", 1),("j2Eta", "Jet 2 Eta", 1),("j1Eta", "Jet 1 Eta", 1),("j2Phi", "Jet 2 Phi", 1),("j1Phi", "Jet 1 Phi", 1),("e_m_Mass", "Electron + Muon Mass (GeV)", 1),("e_m_CollMass", "Electron + Muon Collinear Mass (GeV)", 1),("e_m_PZeta", "Electron + PZeta", 1),("numOfJets", "Number of Jets", 1),("vbfMass", "VBF Mass", 1),("numOfVtx", "Number of Vertices", 1),("dEtaEMu", "Delta Eta E Mu", 1),("dPhiEMET", "Delta Phi E MET", 1),("dPhiMuMET", "Delta Phi Mu MET", 1),("dPhiEMu", "Delta Phi E Mu", 1),("MTEMET", "Electron MET Transverse Mass (GeV)", 1),("MTMuMET", "Mu MET Transverse Mass (GeV)", 1)]
