...
for x in mc_samples:
    print x
    files.extend(glob.glob('../results/%s/AnalyzeEMuQCD/%s' % (jobid, x)))
...
for j in jet:
    ...
    outputdir = 'plots/%s/AnalyzeEMuQCD/2016SelectionsEmbed/%s/' % (jobid, s1)
    ...
    histoname = [("mPt", "Muon  Pt (GeV)", 1),("ePt", "Electron Pt (Gev)", 1),("mEta", "Muon Eta", 1),("eEta", "Electron Eta", 1),("mPhi", "Muon Phi", 2),("ePhi", "Electron Phi", 1),("type1_pfMetEt", "Type1 MET Et", 1),("type1_pfMetPhi", "Type1 MET Phi", 1),("e_m_Mass", "Electron + Muon Mass (GeV)", 1),("e_m_CollMass", "Electron + Muon Collinear Mass (GeV)", 1),("e_m_PZeta", "Electron + Muon PZeta", 1),("numOfJets", "Number of Jets", 1),("numOfVtx", "Number of Vertices", 1),("dEtaEMu", "Delta Eta E Mu", 1),("dPhiEMET", "Delta Phi E MET", 1),("dPhiMuMET", "Delta Phi Mu MET", 1),("dPhiEMu", "Delta Phi E Mu", 1),("MTEMET", "Electron MET Transverse Mass (GeV)", 1),("MTMuMET", "Mu MET Transverse Mass (GeV)", 1)]
