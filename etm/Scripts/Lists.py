...
def normQCD(histogram, i, j, category):
    qcd = histogram.Clone()
    if category=='0Jet':
        integ = [4630.006, 4695.286, 4564.724, 4630.006, 4630.006, 4630.006, 4630.006, 4479.311, 4780.692, 4630.006, 4630.006, 4630.006, 4630.006, 4129.579, 5271.417]
        qcd.Scale(integ[j]/i)
    elif category=='1Jet':
        integ = [1212.206, 1212.206, 1212.206, 1238.114, 1186.298, 1212.206, 1212.206, 1212.206, 1212.206, 1221.448, 1202.964, 1212.206, 1212.206, 1071.803, 1393.066]
        qcd.Scale(integ[j]/i)
    elif category=='2Jet':
        integ = [357.016, 357.016, 357.016, 357.016, 357.016, 366.925, 347.107, 357.016, 357.016, 357.016, 357.016, 359.011, 355.021, 317.694, 409.205]
        qcd.Scale(integ[j]/i)
    elif category=='2JetVBF':
        integ = [56.465, 56.465, 56.465, 56.465, 56.465, 58.012, 54.918, 56.465, 56.465, 56.465, 56.465, 56.73, 56.2, 52.502, 61.636]
        qcd.Scale(integ[j]/i)
    return qcd
...
def normQCDBDT(histogram, i, j, category):
    qcd = histogram.Clone()
    if category=='0Jet':
        integ = [21680.761, 22060.722, 21300.79, 21680.761, 21680.761, 21680.761, 21680.761, 20965.49, 22395.99, 21680.761, 21680.761, 21680.761, 21680.761, 19969.671, 23905.556]
        qcd.Scale(integ[j]/i)
    elif category=='1Jet':
        integ = [8219.098, 8219.098, 8219.098, 8377.256, 8060.94, 8219.098, 8219.098, 8219.098, 8219.098, 8235.91, 8202.285, 8219.098, 8219.098, 7465.301, 9194.972]
        qcd.Scale(integ[j]/i)
    elif category=='2Jet':
        integ = [2261.68, 2261.68, 2261.68, 2261.68, 2261.68, 2318.993, 2204.364, 2261.68, 2261.68, 2261.68, 2261.68, 2260.898, 2262.461, 2037.301, 2547.832]
        qcd.Scale(integ[j]/i)
    elif category=='2JetVBF':
        integ = [394.11, 394.11, 394.11, 394.11, 394.11, 404.191, 384.028, 394.11, 394.11, 394.11, 394.11, 394.205, 394.074, 373.199, 423.315]
        qcd.Scale(integ[j]/i)
    return qcd
