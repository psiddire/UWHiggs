...
for k, di in enumerate(Lists.dirs):
    ...
    if di=='0Jet':
        ...
        binning = array.array('d', [-0.5, -0.4, -0.35, -0.3, -0.25, -0.2, -0.15, -0.1, -0.05, 0.0, 0.05, 0.1, 0.15, 0.25])
    elif di=='2Jet':
        binning = array.array('d', [-0.45, -0.35, -0.3, -0.25, -0.2, -0.15, -0.1, -0.05, 0.0, 0.05, 0.1, 0.15, 0.2])
    else:
        binning = array.array('d', [-0.5, -0.3, -0.2, -0.1, 0.0, 0.1, 0.2])
