...
for k, di in enumerate(Lists.dirs):
    ...
    d.cd()
    if di=='0Jet':
        binning = array.array('d', [-1.0, -0.45, -0.35, -0.3, -0.25, -0.2, -0.15, -0.1, -0.05, 0.0, 0.05, 0.1, 0.25, 1.0])
    elif di=='1Jet':
        binning = array.array('d', [-1.0, -0.5, -0.35, -0.3, -0.25, -0.2, -0.15, -0.1, -0.05, 0.0, 0.05, 0.1, 0.25, 1.0])
    elif di=='2Jet':
        binning = array.array('d', [-1.0, -0.45, -0.35, -0.3, -0.25, -0.2, -0.15, -0.1, -0.05, 0.0, 0.05, 0.1, 0.25, 1.0])
    else:
        binning = array.array('d', [-1.0, -0.45, -0.35, -0.25, -0.2, -0.15, -0.1, -0.05, 0.0, 0.05, 0.1, 0.2, 1.0])
