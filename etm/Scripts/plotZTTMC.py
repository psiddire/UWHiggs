...
for j in jet:
    ...
    outputdir = 'plots/%s/AnalyzeMuEZTT/2017SelectionsEmbedDY/%s/' % (jobid, s1)
    ...
    DY = views.TitleView(DY, "Z#rightarrow#mu#mu/ee/#tau#tau")
