...
# File
#f = ROOT.TFile.Open('shapesEMuBDT.root', 'READ')
#f = ROOT.TFile.Open('shapesEMuBDTQCD.root', 'READ')
f = ROOT.TFile.Open('shapesEMu.root', 'READ')
#f = ROOT.TFile.Open('shapesEMuQCD.root', 'READ')

#fNew = ROOT.TFile.Open('NewShapes/shapesEMuBDT.root', 'RECREATE')
#fNew = ROOT.TFile.Open('NewShapes/shapesEMuBDTQCD.root', 'RECREATE')
fNew = ROOT.TFile.Open('NewShapes/shapesEMu.root', 'RECREATE')
#fNew = ROOT.TFile.Open('NewShapes/shapesEMuQCD.root', 'RECREATE')
