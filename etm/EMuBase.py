...
class EMuBase():
  ...
  def begin(self):
    for n in Kinematics.plotnames:
      ...
      self.book(n, 'e_m_PZetaVis', 'Electron + Muon PZeta Visible', 80, -400, 400)
      self.book(n, 'e_m_PZetaSub', 'Electron + Muon PZeta Subtracted', 80, -400, 400)
  ...
  def fill_histos(self, row, myEle, myMET, myMuon, weight, name=''):
    ...
    histos[name+'/e_m_PZetaVis'].Fill(row.e_m_PZetaVis, weight)
    histos[name+'/e_m_PZetaSub'].Fill(row.e_m_PZeta - 0.85*row.e_m_PZetaVis, weight)
