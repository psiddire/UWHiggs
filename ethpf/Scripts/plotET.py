...
for j in jet:
    ...
    outputdir = 'plots/%s/AnalyzeETau/2017SelectionsEmbedNewFake/%s/' % (jobid, s1)
    ...
    histoname = [('ePt', 'e p_{T} (GeV)', 1),('tPt', '#tau p_{T} (GeV)', 1),('eEta', 'e #eta', 1),('tEta', '#tau #eta', 1),('ePhi', 'e #phi', 1),('tPhi', '#tau #phi', 1),('j2Pt', 'Jet 2 p_{T}', 1),('j1Pt', 'Jet 1 p_{T}', 1),('j2Eta', 'Jet 2 #eta', 1),('j1Eta', 'Jet 1 #eta', 1),('j2Phi', 'Jet 2 #phi', 1),('j1Phi', 'Jet 1 #phi', 1),('type1_pfMetEt', 'MET (GeV)', 1),('type1_pfMetPhi', 'MET #phi', 1),('e_t_Mass', 'M_{vis}(e, #tau) (GeV)', 1),('e_t_CollinearMass', 'M_{col}(e, #tau) (GeV)', 1),('e_t_PZeta', 'p_{#zeta}(e, #tau) (GeV)', 1),('numOfJets', 'Number Of Jets', 1),('vbfMass', 'VBF Mass', 1),('numOfVtx', 'Number of Vertices', 1),('dEtaETau', '#Delta#eta(e, #tau)', 1),('dPhiEMET', '#Delta#phi(e, MET)', 1),('dPhiTauMET', '#Delta#phi(#tau, MET)', 1),('dPhiETau', '#Delta#phi(e, #tau)', 1),('MTEMET', 'M_{T}(e, MET) (GeV)', 1),('MTTauMET', 'M_{T}(#tau, MET) (GeV)', 1)]
