...
for x in mc_samples:
    print x
    files.extend(glob.glob('results/lpairs_data_Aug5/AnalyzeMuMu/%s' % (x)))
    lumifiles.extend(glob.glob('inputs/lpairs_data_Aug5/%s.lumicalc.sum' % (x)))

period = '13TeV'
sqrts = 13
outputdir = 'plots/lpairs_data_Aug5/AnalyzeMuMu/MuMuAug23/'# % (jobid)
...
histoname = [("m1Pt", "Muon 1 Pt", 1),("m2Pt", "Muon 2 Pt",1),("m1Eta", "Muon 1 Eta", 1),("m2Eta", "Muon 2 Eta",1),("m1Phi", "Muon 1 Phi", 1),("m2Phi", "Muon 2 Phi",1),("nvtx", "Number of Vertices", 1),("m1_m2_Mass", "Visible Mass", 1)]
