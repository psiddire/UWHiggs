...
files=[]
lumifiles=[]
channel = ['initial', 'muonloose', 'muontight']
for x in mc_samples:
    print x
...
period = '13TeV'
sqrts = 13
outputdir = 'plots/%s/AnalyzeEEMu/EEMOct4/' % (jobid)
...
histoname = [("mPt", "Muon Pt", 1), ("mEta", "Muon Eta", 1), ("e1_e2_Mass", "Visible Mass", 1), ("e1Pt", "Electron 1 Pt", 1), ("e1Eta", "Electron 1 Eta", 1), ("e2Pt", "Electron 2 Pt", 1), ("e2Eta", "Electron 2 Eta", 1)]
