...
for d in dirs:
    ...
    histoname = [("mPt", "Muon p_{T} (GeV)", 1), ("mEta", "Muon #eta", 1), ("e1_e2_Mass", "M_{vis}(e, e) (GeV)", 1), ("e1Pt", "Ele 1 p_{T} (GeV)", 1), ("e1Eta", "Ele 1 #eta", 1), ("e2Pt", "Ele 2 p_{T} (GeV)", 1), ("e2Eta", "Ele 2 #eta", 1)]
    ...
    for fn in foldername:
        ...
        for n,h in enumerate(histoname):
            plotter.plot_mc_vs_data(fn, [], h[0], 1, xaxis = h[1], leftside=False, xrange=None, preprocess=None, show_ratio=True, ratio_range=1.5, sort=True, blind_region=True, control=d, jets='', year='2017', channel='eemu')
            plotter.save(h[0])
