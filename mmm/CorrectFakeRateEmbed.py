...
if __name__ == "__main__":
    ...
    emb_numerator = emb_view.Get(args.numerator)
    emb_denominator = emb_view.Get(args.denom)
    ...
    emb_numerator.SetName('numerator_emb')
    emb_denominator.SetName('denominator_emb')

    embfakerate = ROOT.TEfficiency(emb_numerator, emb_denominator)
    embfakerate.SetName('embfakerate')
    embfakerate.Draw("ep")
