...
for x in mc_samples:
    print x
    files.extend(glob.glob('results/%s/AnalyzeMuEQCD/%s' % (jobid, x)))
...
for j in jet:
    ...
    outputdir = 'plots/%s/AnalyzeMuEQCD/April22Embed/%s/' % (jobid, s1)
    ...
    new_mc_samples = []
    new_mc_samples.extend(['embed', 'DY', 'TT', 'W', 'WG', 'ST', 'EWKDiboson', 'EWK', 'DYlow', 'SMH', 'QCD']) 
    #new_mc_samples.extend(['DY', 'TT', 'W', 'WG', 'ST', 'EWKDiboson', 'EWK', 'DYlow', 'SMH', 'QCD'])
    plotter.mc_samples = new_mc_samples

    histoname = [("mPt", "Muon  Pt (GeV)", 1),("ePt", "Electron Pt (Gev)", 1),("mEta", "Muon Eta", 1),("eEta", "Electron Eta", 1),("mPhi", "Muon Phi", 2),("ePhi", "Electron Phi", 1),("type1_pfMetEt", "Type1 MET Et", 1),("type1_pfMetPhi", "Type1 MET Phi", 1),("m_e_Mass", "Muon + Electron Mass (GeV)", 1),("m_e_CollinearMass", "Muon + Electron Collinear Mass (GeV)", 1),("numOfJetsWO", "Number of Jets WO", 1),("numOfJets", "Number of Jets", 1),("numOfVtx", "Number of Vertices", 1),("dEtaMuE", "Delta Eta Mu E", 1),("dPhiEMET", "Delta Phi E MET", 1),("dPhiMuMET", "Delta Phi Mu MET", 1),("dPhiMuE", "Delta Phi Mu E", 1),("MTEMET", "Electron MET Transverse Mass (GeV)", 1),("MTMuMET", "Mu MET Transverse Mass (GeV)", 1)]
