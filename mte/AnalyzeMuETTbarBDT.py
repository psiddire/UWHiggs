...
class AnalyzeMuETTbarBDT(MegaBase):
  ...
  def __init__(self, tree, outfile, **kwargs):
    ...
    super(AnalyzeMuETTbarBDT, self).__init__(tree, outfile, **kwargs)
    ...
    for row in self.tree:
      ...
      if self.obj1_iso(row) and self.obj2_iso(row):
        if self.oppositesign(row):
          ...
          if njets==0:
            self.fill_histos(myMuon, myMET, myEle, njets, mjj, weight, 'TightOS0Jet')
          elif njets==1:
            self.fill_histos(myMuon, myMET, myEle, njets, mjj, weight, 'TightOS1Jet')
          elif njets==2 and mjj < 550:
            self.fill_histos(myMuon, myMET, myEle, njets, mjj, weight, 'TightOS2Jet')
          elif njets==2 and mjj > 550:
            self.fill_histos(myMuon, myMET, myEle, njets, mjj, weight, 'TightOS2JetVBF')
        if not self.oppositesign(row):
          self.fill_histos(myMuon, myMET, myEle, njets, mjj, weight*osss, 'TightSS')
          if njets==0:
            self.fill_histos(myMuon, myMET, myEle, njets, mjj, weight*osss, 'TightSS0Jet')
          elif njets==1:
            self.fill_histos(myMuon, myMET, myEle, njets, mjj, weight*osss, 'TightSS1Jet')
          elif njets==2 and mjj < 550:
            self.fill_histos(myMuon, myMET, myEle, njets, mjj, weight*osss, 'TightSS2Jet')
          elif njets==2 and mjj > 550:
            self.fill_histos(myMuon, myMET, myEle, njets, mjj, weight*osss, 'TightSS2JetVBF')
