  ...
  def process(self):
    ...
    for row in self.tree:
      ...
      if self.is_embed:
        ...
        self.we.var("gt2_pt").setVal(myMuon.Pt())
        self.we.var("gt2_eta").setVal(myMuon.Eta())
        ...
        weight = weight*row.GenWeight*m_trg_sf*m_id_sf*m_iso_sf*m_trk_sf*msel*esel*trgsel*e_id_sf*e_iso_sf*e_trk_sf
