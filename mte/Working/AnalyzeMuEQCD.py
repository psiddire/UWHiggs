...
class AnalyzeMuEQCD(MegaBase):
  ...
  def begin(self):
    folder = []
    vbffolder = []
    names=['MuonAIsoOS', 'MuonAIsoSS', 'MuonAIsoOS0Jet', 'MuonAIsoSS0Jet', 'MuonAIsoOS1Jet', 'MuonAIsoSS1Jet', 'MuonAIsoOS0JetCut', 'MuonAIsoSS0JetCut', 'MuonAIsoOS1JetCut', 'MuonAIsoSS1JetCut']
    vbfnames=['MuonAIsoOS2Jet', 'MuonAIsoSS2Jet', 'MuonAIsoOS2JetCut', 'MuonAIsoSS2JetCut', 'MuonAIsoOS2JetVBF', 'MuonAIsoSS2JetVBF', 'MuonAIsoOS2JetVBFCut', 'MuonAIsoSS2JetVBFCut']
    namesize = len(names)
