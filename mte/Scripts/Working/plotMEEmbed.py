...
for x in mc_samples:
    print x
    files.extend(glob.glob('../results/%s/AnalyzeMuEHTT/%s' % (jobid, x)))
...
for j in jet:
    ...
    outputdir = 'plots/%s/AnalyzeMuEHTT/2016SelectionsEmbed/%s/' % (jobid, s1)
