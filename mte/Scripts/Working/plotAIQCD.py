...
for i, j in enumerate(jet):
    ...
    outputdir = 'plots/%s/AnalyzeMuEQCD/QCDNewShape/%s/' % (jobid, s1)
    ...
    if i==0:
        ...
        QCD = views.ScaleView(QCD, 1260.73956656)
    if i==1:
        QCD = views.NormalizeView(QCD, 1.0)
        QCD = views.ScaleView(QCD, 637.990314364) 
    if i==2:
        QCD = views.NormalizeView(QCD, 1.0)
        QCD = views.ScaleView(QCD, 465.537204862)
    if i==3:
        QCD = views.NormalizeView(QCD, 1.0)
        QCD = views.ScaleView(QCD, 149.363916814)
    if i==4:
        QCD = views.NormalizeView(QCD, 1.0)
        QCD = views.ScaleView(QCD, 12.2519552708)
    if i==5:
        QCD = views.NormalizeView(QCD, 1.0)
        QCD = views.ScaleView(QCD, 80.6322697401)
    if i==6:
        QCD = views.NormalizeView(QCD, 1.0)
        QCD = views.ScaleView(QCD, 46.3342633247)
    if i==7:
        QCD = views.NormalizeView(QCD, 1.0)
        QCD = views.ScaleView(QCD, 22.7301487923) 
    if i==8:
        QCD = views.NormalizeView(QCD, 1.0)
        QCD = views.ScaleView(QCD, 0.0) 
