...
for di in dirs:
    ...
    if di=='0Jet':
        dr = '0jet'
        binning = array.array('d', [-0.45, -0.35, -0.3, -0.25, -0.2, -0.15, -0.1, -0.05, 0.0, 0.05, 0.1, 0.15, 0.25])
    elif di=='1Jet':
        dr = '1jet'
        binning = array.array('d', [-0.45, -0.35, -0.3, -0.25, -0.2, -0.15, -0.1, -0.05, 0.0, 0.05, 0.1, 0.15, 0.25])
    elif di=='2Jet':
        dr = '2jet_gg'
        binning = array.array('d', [-0.45, -0.35, -0.3, -0.25, -0.2, -0.15, -0.1, -0.05, 0.0, 0.05, 0.1, 0.25])
    else:
        dr = '2jet_vbf'
        binning = array.array('d', [-0.45, -0.35, -0.3, -0.25, -0.2, -0.15, -0.1, -0.05, 0.0, 0.05, 0.1, 0.25])
    ...
    #embeesiup = embeesiup.Rebin(len(binning)-1, "ZTauTau_CMS_EESigma_13TeVUp", binning)
    #embeesidown = emball.Get('eesiDown/bdtDiscriminator')
    #embeesidown = positivize(embeesidown)
    #embeesidown = embeesidown.Rebin(len(binning)-1, "ZTauTau_CMS_EESigma_13TeVDown", binning)
